...
class PictureUploader < CarrierWave::Uploader::Base
  ...
  #   # ActionController::Base.helpers.asset_path("fallback/" + [version_name, "default.webp"].compact.join('_'))
  #
...
![](./gallery_layout/2015-02-01_09-15-25_zps70fcf00e.webp)

이렇게 해서 게시판은 총 4개가 되었다.

![](./gallery_layout/2015-02-01_09-18-38_zps3ceb0979.webp)
...
![](./gallery_layout/2015-02-01_13-03-17_zps11cb5681.webp)
...
이제 `.jpg`, `.jpeg`, `.gif`, `.webp`, `.pdf` 확장자를 가진 파일만 업로드할 수 있게 된다.

이러한 파일확장자 이외의 파일을 업로드하면 아래와 같은 에러 메시지가 표시된다.

![](./gallery_layout/2015-02-01_13-32-37_zps404bdb11.webp)



`.pdf` 파일을 업로드할 경우에는 `pdf` 파일의 첫페이지가 쎔네일 이미지로 만들어진다.

![](./gallery_layout/2015-02-01_16-46-07_zps8d9481b4.webp)
...
![](./gallery_layout/2015-02-01_14-21-30_zpsbd72d3bc.webp)
