...
![](./ubuntu14server/2014-10-09_17-07-11_zps3e73006b.png)

#### 2. 운영체제 이름을 설정한다.

![](./ubuntu14server/2014-10-09_17-09-08_zpsd8c4cef1.png)
...
![](./ubuntu14server/2014-10-09_17-10-23_zpsb958b248.png)

#### 5. 하드 드라이브는 기본설정으로 두번째 항목으로 만들기 한다.

![](./ubuntu14server/2014-10-09_17-10-52_zps6a953a70.png)

#### 6. 하드 드라이브 파일 종류는 기본값인 첫번째 항목으로 계속한다.

![](./ubuntu14server/2014-10-09_17-11-05_zps90efff64.png)

#### 7. 물리적 하드 드라이브에 저장에서는 기본값인 첫번째 항목(동적할당)으로 계속한다.

![](./ubuntu14server/2014-10-09_17-11-22_zps7ea91b5a.png)

#### 8. 파일 위치 및 크기는 기본값인 8.00 GB 상태로 만들기한다.

![](./ubuntu14server/2014-10-09_17-11-57_zps98742c18.png)

#### 9. 가상머신 설정

: 방금 생성된 `1번` 항목에서 마우스의 오른쪽 버튼을 클릭하여...

![](./ubuntu14server/2014-10-09_17-12-16_zps7f52e6c7.png)

설정 항목을 선택한다.

![](./ubuntu14server/2014-10-09_17-13-41_zpsf2d15e8b.png)

#### 10. 네트워크 1번 어댑터 탭에서 `브리지 어댑터`를 선택하고 확인 버튼을 클릭한다.

![](./ubuntu14server/2014-10-09_17-14-39_zps19417f89.png)

#### 11. 가상머신 시작하기

![](./ubuntu14server/2014-10-09_17-15-08_zpsa1a0eba0.png)

#### 12. 다운로드 받은 서버 이미지 선택하기

: 미리 다운로드 받아 놓은 우분투 서버 이미지 파일을 선택한다.

![](./ubuntu14server/2014-10-09_17-40-56_zpsbe3b9ab3.png)
...
![](./ubuntu14server/2014-10-09_17-41-16_zpsc5a91cd7.png)

#### 14. 사용할 언어를 선택하는 화면에서 기본값인 `English`가 반전된 상태에서 엔터키를 클릭한다.

![](./ubuntu14server/2014-10-09_20-30-10_zps537967a4.png)

#### 15. 우분투 서버 설치 항목을 선택한다.

![](./ubuntu14server/2014-10-09_20-30-48_zps7f1d2bc2.png)

#### 16. 설치 진행시 사용할 언어를 선택하는 화면에서도 기본값인 `English`가 반전된 상태에서 엔터키를 클릭한다.

![](./ubuntu14server/2014-10-09_20-31-06_zps23f878b3.png)

#### 17. 타임존 설정을 위한 지역을 선택하는 화면에서는 `other` 항목을 선택하고 엔터키를 클릭한다.

![](./ubuntu14server/2014-10-09_20-31-30_zps912204f9.png)

이어지는 화면에서는 `Asia`를 선택하고 엔터키를 클릭한다.

![](./ubuntu14server/2014-10-09_20-31-46_zpsc4d8a97f.png)

그리고 `Korea, Republic of`을 선택한 후 엔터키를 클릭한다.

![](./ubuntu14server/2014-10-09_20-31-58_zps10e914fd.png)

#### 18. 로케일 설정 화면에서는 기본값인 `United States - en_US.UTF-8`이 반전된 상태에서 엔터키를 클릭한다.

![](./ubuntu14server/2014-10-09_20-32-15_zpsdac493d4.png)

#### 19. 키보드 검색 화면에서는 기본값인 `<No>`를 선택한다.

![](./ubuntu14server/2014-10-09_20-32-30_zpsca25f5d6.png)

#### 20. 키보드 레이아웃 선택 화면(Country of origin)에서는 기본값인 `English (US)`를 선택한다.

![](./ubuntu14server/2014-10-09_20-32-41_zps14173eca.png)

#### 21. 키보드 레이아웃도 기본값인 `English (US)`를 선택한다.

![](./ubuntu14server/2014-10-09_20-32-53_zps5f9742d7.png)

#### 22. 컴포넌트 진행과정

![](./ubuntu14server/2014-10-09_20-33-21_zpscb4461c1.png)

#### 23. 가상머신에 사용한 호스트이름을 정한다.

![](./ubuntu14server/2014-10-09_20-34-08_zpsb41a467c.png)

#### 24. 유저 이름을 입력한다.

![](./ubuntu14server/2014-10-09_20-34-34_zpsc5e8d6e7.png)

#### 25. 계정 이름을 입력한다.

![](./ubuntu14server/2014-10-09_20-35-04_zps38bc58e5.png)

#### 26. 암호를 입력한다.

![](./ubuntu14server/2014-10-09_20-35-18_zps09f8cfd4.png)

동일한 암호를 한번 더 입력한다.

![](./ubuntu14server/2014-10-09_20-35-33_zps5c73206a.png)

#### 27. 홈 디렉토리 암호화 여부는 기본값인  `<No>`를 선택한다.

![](./ubuntu14server/2014-10-09_20-35-45_zps08364769.png)

#### 28. 하드디스크 파티션 방법은 기본값인 `use entire disk and set up LVM`을 선택한다.

![](./ubuntu14server/2014-10-09_20-36-59_zps20604641.png)

#### 29. 파티션할 디스크 선택은 기본값을 선택한다.

![](./ubuntu14server/2014-10-09_20-37-38_zpsb8cabb4c.png)

#### 30. 변경 내용을 저장 화면에서 `<Yes>`를 선택한다.

![](./ubuntu14server/2014-10-09_20-37-59_zpsf221e67e.png)

#### 31. 디스크 볼륨도 기본값으로 선택하고 계속한다.

![](./ubuntu14server/2014-10-09_20-38-36_zps25eb0cb4.png)

#### 32. 변경 내용을 저장하는 화면에서 `<Yes>`를 선택한다.

![](./ubuntu14server/2014-10-09_20-38-50_zps4f265967.png)

#### 33. 시스템 설치 과정

![](./ubuntu14server/2014-10-09_20-39-12_zpscf02672b.png)

#### 34. Proxy 정보를 지정하지 않고 계속해도 된다.

![](./ubuntu14server/2014-10-09_20-40-00_zpse1bda256.png)

#### 35. 설치 진행과정 (1)

![](./ubuntu14server/2014-10-09_20-40-26_zpse6d1e429.png)

설치 진행과정 (2)

![](./ubuntu14server/2014-10-09_20-41-32_zps8b563417.png)

#### 36. 시스템 업데이트는 수동으로 지정한다. 기본값으로 진행한다.

![](./ubuntu14server/2014-10-09_20-41-40_zps4d77070f.png)

#### 37. 설치할 소프트웨어는 `OpenSSH server`만 선택(스페이스바를 클릭)한 후 계속한다.

![](./ubuntu14server/2014-10-09_20-42-10_zps84c26dae.png)

#### 38. 설치 진행과정

![](./ubuntu14server/2014-10-09_20-42-25_zpsd7732abf.png)

#### 39. GRUB 부트로더 설치는 `<Yes>`를 선택한다.

![](./ubuntu14server/2014-10-09_20-43-04_zps038926fe.png)

#### 40. 설치완료

![](./ubuntu14server/2014-10-09_20-43-19_zpsb36c70a7.png)

#### 41. 시스템 부팅 시작 화면

![](./ubuntu14server/2014-10-09_20-43-33_zps69e3bded.png)

#### 42. 로그인 화면

아래와 같은 로그인 화면이 나타나면 등록한 유저 계정명과 암호를 이용하여 로그인한다.

![](./ubuntu14server/2014-10-09_20-43-42_zpsc761400f.png)

##### 43. 로그인 후 화면

![](./ubuntu14server/2014-10-09_20-44-43_zps34760bf7.png)
...
![](./ubuntu14server/2014-10-09_20-45-20_zpsa16c80be.png)
...
![](./ubuntu14server/2014-10-09_20-48-26_zps920cf4be.png)

최초 접속시에는 아래와 같이 호스트 인증관련 메시지가 나타나며 `yes`를 입력한다.

![](./ubuntu14server/2014-10-09_20-49-18_zps06b29c64.png)

이어서 나타나는 화면에서는 암호를 입력한다.

![](./ubuntu14server/2014-10-09_20-49-49_zpsd6e7993f.png)

#### 호스트에서 게스트 PC로 ssh 접속 후 나타나는 화면

접속한 게스트 PC(가상머신)의 IP를 시스템 정보에서 찾을 수 있다.

![](./ubuntu14server/2014-10-09_20-50-04_zps39c575c2.png)
